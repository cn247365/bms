...
namespace WebApp
{
  ...
  {
    public static Task<DataTable> GetDataTableFromExcelAsync(Stream stream, string type = ".xlsx") => Task.Run(() =>
    {
    ...
    public static Task<MemoryStream> ExportExcelAsync<T>(string name, List<T> list, Models.ExpColumnOpts[] colopts=null) => Task.Run(() => {
