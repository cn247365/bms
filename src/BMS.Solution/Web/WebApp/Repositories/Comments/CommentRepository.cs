...
/// Created Date: 1/30/2021 9:47:24 PM
/// Author: neo.zhu
...
/// </summary>
  public static class CommentRepository  
    {
                 public static async Task<IEnumerable<Comment>> GetByParentId(this IRepositoryAsync<Comment> repository, int parentid)
          => await repository
                .Queryable()
                .Where(x => x.ParentId==parentid).ToListAsync();
              
          
                 public static async Task<IEnumerable<Comment>> GetByBookId(this IRepositoryAsync<Comment> repository, int bookid)
          => await repository
                .Queryable()
