...
/// </summary>
  public static class BookPictureRepository  
    {
                 public static async Task<IEnumerable<BookPicture>> GetByBookId(this IRepositoryAsync<BookPicture> repository, int bookid)
          => await repository
                .Queryable()
