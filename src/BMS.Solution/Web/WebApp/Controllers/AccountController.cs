  ...
  public class AccountController : Controller
  {
    ...
    public async Task<ActionResult> Register(AccountRegistrationModel viewModel)
    {
      ...
      try
      {
        ...
        if (viewModel.Avatars != "ng.jpg")
        {
          this.saveToAvatar(viewModel.Avatars, viewModel.Username);
          viewModel.Avatars = $"{ viewModel.Username}.png";
        }
        ...
        var user = new ApplicationUser
        {
          ...
          AccountType = 0,
          Avatars = viewModel.Avatars=="ng.jpg"? "ng.jpg":$"{ viewModel.Username}.png",
          AvatarsX120 = viewModel.Avatars == "ng.jpg" ? "ng.jpg" : $"{ viewModel.Username}.png",
        ...
        await this.UserManager.AddClaimAsync(user.Id, new System.Security.Claims.Claim(System.Security.Claims.ClaimTypes.GivenName, string.IsNullOrEmpty(user.GivenName) ? "" : user.GivenName));
    ...
    public async Task<JsonResult> UpdateAvatar(string base64str) {
      ...
      var identity =await this.UserManager.FindByNameAsync(username);
